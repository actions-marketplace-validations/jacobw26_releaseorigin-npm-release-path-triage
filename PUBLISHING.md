...
9. Confirm the README bootstrap example uses `jacobw26/releaseorigin-npm-release-path-triage@main`, labels `main` as mutable, and tells production consumers to pin a reviewed full commit SHA.
